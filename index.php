...
<body>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
        		<p>
                Dapoer mommi era menyediakan berbagai jenis makanan khas yang dapat di pesan secara online dengan metode pembayaran via online
				</p>
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Dapoer Mommi Era siap mengirim pesanan anda secara gratis dengan radius maksimal 10 KM.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Rasa Juara</h3>
								<p>Dapoer Mommi Era memiliki cita rasa yang unik dan khas , di proses higienis dan dari bahan berkualitas.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
...
<div class="span2">
    <div id="footer-menu-logo">
        <a href="#"><img src="img/logodapoer.png" alt="logo" width="120" height="50"/></a>
    </div>
</div>
