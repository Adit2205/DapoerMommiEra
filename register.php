	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-user ico-white"></i>Registrasi Pembeli</h2>
...
if (isset($_POST['input'])) {
    ...
    if (mysqli_num_rows($cek) == 0) {
        $insert = mysqli_query($koneksi, "INSERT INTO customer (kd_cus, nama, alamat, no_telp, username, password) VALUES ('$kd_cus', '$nama', '$alamat', '$no_telp', '$username', '$password')") or die(mysqli_error($koneksi));
        if ($insert) {
...
<div class="table-responsive">
    ...
    <div class="hero-unit">Harap isi form dibawah ini dengan lengkap dan benar sesuai identitas anda!
        <p></p> Setelah form terisi selanjutnya Login sebagai Customer !
    </div>
    <form role="formku" id="formku" method="post" action="" enctype="multipart/form-data">
