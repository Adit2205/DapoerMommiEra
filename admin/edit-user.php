           ...
           <!-- /.row -->
            ...
            ?>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-user.php" method="post" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">User ID</label>
                              <div class="col-sm-10">
                                  <input name="kd_cus" type="text" id="kd_cus" class="form-control" value="<?php echo $data['kd_cus'];?>" readonly="readonly" autofocus="on" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="alamat" type="text" id="alamat" class="form-control" value="<?php echo $data['alamat'];?>" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Telepon</label>
                              <div class="col-sm-10">
                                  <input name="no_telp" class="form-control" id="no_telp" type="text" value="<?php echo $data['no_telp'];?>" required />
                              </div>
                          </div>
                          <div class="form-group">
