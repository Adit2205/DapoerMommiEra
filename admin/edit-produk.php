...
if(isset($_POST['update'])){
    ...
    // If a new file is uploaded, process the file
    if (!empty($_FILES["nama_file"]["tmp_name"])) {
        ...
        if($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/x-png") {
            ...
            if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
                $sql = "UPDATE produk SET nama='$nama', jenis='$jenis', harga='$harga', keterangan='$keterangan', stok='$stok', gambar='$gambar' WHERE kode='$kode'";
        ...
        // If no new file is uploaded, update without changing the image
        $sql = "UPDATE produk SET nama='$nama', jenis='$jenis', harga='$harga', keterangan='$keterangan', stok='$stok' WHERE kode='$kode'";
        $res = mysqli_query($koneksi, $sql) or die (mysqli_error($koneksi));
        echo "<script>alert('Data Produk berhasil diupdate!'); window.location = 'produk.php'</script>";
    }
}
