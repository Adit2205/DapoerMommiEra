...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            ?>
              ...
              <div class="col-lg-4">
              <form action='po_terima.php' method="POST">
          
           <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Pesanan' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='po_terima.php' class="btn btn-sm btn-success" >Refresh</i></a>
            </div>
              </div>
           <!-- /.row -->
                    <br />
                   ...
                   <?php
    $query1 = "SELECT po_terima.*, produk.nama AS nama_produk, customer.nama AS nama_customer FROM po_terima 
    ...
    $query1 = "SELECT po_terima.*, produk.nama AS nama_produk, customer.nama AS nama_customer FROM po_terima 
               INNER JOIN produk ON po_terima.kode = produk.kode
               INNER JOIN customer ON po_terima.kd_cus = customer.kd_cus 
               WHERE po_terima.nopo LIKE '%$qcari%' OR customer.nama LIKE '%$qcari%'";
}
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['nama_customer'];?></center></td>
                   <td><center><?php echo $data['nama_produk'];?></center></td>
                   <td><center><?php echo $data['tanggal'];?></center></td>
                    <td><center><?php echo $data['qty']; ?></center></td>
                    <td><center><?php echo 'Rp ' . number_format($data['total'], 0, ',', '.');?></center></td>
