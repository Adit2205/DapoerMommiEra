...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='konfirmasi_pembayaran.php' class="btn btn-sm btn-success" >Refresh</i></a>
            </div>
              </div>
           <!-- /.row -->
                    <br />
    ...
    while($data2 = mysqli_fetch_array($hasil2)) { 
      if ($data2['status'] == 'Proses' ) { ?>
        <tr>
          ...
          <td><center>
            <div id="thanks">
              <a class="btn btn-sm btn-warning" href="update_status.php?id=<?php echo $data2['id_kon']; ?>&status=Bayar">Bayar</a>
              <a class="btn btn-sm btn-danger" href="tidakvalid.php?id=<?php echo $data2['id_kon']; ?>&status=Tidak Valid">Tidak Valid</a>
            </div>
          </center></td>
        </tr>
    <?php }} ?>
