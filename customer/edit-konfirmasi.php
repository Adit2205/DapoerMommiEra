...
if(mysqli_num_rows($sql) == 0){
    ...
    exit; // Tambahkan exit untuk menghentikan eksekusi jika tidak ada data yang ditemukan
} else {
...
if(isset($_POST['update'])){
    ...
    $update = mysqli_query($koneksi, "UPDATE konfirmasi SET status='Proses' WHERE id_kon='$id_kon'") ;
    if($update){
        header("Location: index1.php?pesan=sukses");
        exit;
    } else {
            ...
            <div class="panel-body">
                <div class="form-panel">
                    <form class="form-horizontal style-form" action="update-konfirmasi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Jenis Pembayaran</label>
                            <div class="col-sm-3">
                        ...
                        <?php if($row['bayar_via'] == 'Transfer Bank') { ?>
                            <div class="form-group">
    <label class="col-sm-2 col-sm-2 control-label">No. Rekening Tujuan</label>
    <div class="col-sm-3">
        <input type="text" name="no_rekening" class="form-control" value="656176278178" style="color: red; font-weight: bold;" readonly>
    </div>
</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="atas_nama" class="form-control" value="Aditya" style="color: red; font-weight: bold;" readonly>
                                </div>
                            </div>
                        <?php } ?>

                        <?php if($row['bayar_via'] == 'Transfer Bank' || $row['bayar_via'] == 'QRIS') { ?>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Bukti Bayar</label>
                                <div class="col-sm-3">
                                    <input type="file" name="nama_file" id="nama_file" class="form-control" accept="image/*, .pdf, .doc, .docx, .xls, .xlsx, .txt" />
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input name="tanggal" type="text" id="tanggal" value="<?php echo $row['tanggal']; ?>" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" required readonly="readonly"/>
                            </div>
                        </div>
                        <div class="form-group">
