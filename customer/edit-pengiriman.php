...
?>
            ...
            <div class="panel-body">
                <div class="form-panel">
                    <form class="form-horizontal style-form" action="ubah-statuspo.php" method="post" name="form1" id="form1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="tanggalkirim" type="date" id="tanggalkirim" class="form-control" value="<?php echo $data['tanggalkirim'];?>" readonly="readonly"  required />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="status-po.php" class="btn btn-danger">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
